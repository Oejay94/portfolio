              ...
              <Card.Text as='div'>
                <ul>
                  <div className="workDiv">
                    ...
                    <li>
                      Primary focus was mentoring and guiding students through
                      the topics of HTML, CSS, Javascript, Node.js, React.js,
                      the Terminal, and Git/Github
                    </li>
                    <li>
                    ...
                    <li>
                      Provided coding demos and walkthroughs to better explain
                      the topics that students were struggling which were done
                      either as 1-1 or in front of my entire block of students.
                    </li>
                    <li>
                ...
                <ul>
                  <div className="workDiv">
                    ...
                    <li>
                      ...
                      Calendars and add the link to a virtual meeting to the
                      users meeting agenda.
                    </li>
                    <li>
                      By the end of the internship, Docket was able to grab
                      links from BlueJeans, GoToMeetings, Microsoft Teams, and
                      more where as before they were only able to grab Zoom and
